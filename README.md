...
- **Hedged requests** for the critical class: a delayed second copy after the rolling p50, first response wins, loser aborted. Four gates, all required: tier ≤ 1, critical pool has headroom, the client asserts idempotency, and Jev does not veto.
